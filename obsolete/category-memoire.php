<?php get_header(); ?>
	...
	<?php 	$category = get_query_var('cat'); $current_cat = get_category($cat); ?>
	<?php $catimg = '/wp-content/themes/magazine-basic/' . 'cma/images/cat-' . $current_cat->slug . '.jpg'; echo '<img src="' . $catimg . '" />'; ?>
